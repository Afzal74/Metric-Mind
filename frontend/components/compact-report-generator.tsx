...
export function CompactReportGenerator({
  reportData,
}: CompactReportGeneratorProps) {
  ...
  const generateCompactPDF = async () => {
    ...
    try {
      ...
      pdf.text(
        `Female: ${reportData.prediction.probabilities.Female}%`,
        20,
        yPos + 16
      );
      pdf.text(
        `Male: ${reportData.prediction.probabilities.Male}%`,
        80,
        yPos + 16
      );
      ...
      pdf.text(
        "Generated by Metric Mind - Advanced Forensic AI Analysis Platform",
        15,
        pageHeight - 10
      );
      ...
      const fileName = `MetricMind_${reportData.prediction.gender_full}_${
        ...
        <CardContent>
          <div className="space-y-4">
            ...
            <div className="text-xs text-gray-400 text-center">
              📄 Optimized single-page report with charts, measurements, and AI
              analysis
            </div>
          </div>
        </CardContent>
