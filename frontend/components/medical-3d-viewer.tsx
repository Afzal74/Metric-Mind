...
import { MedicalMandible } from './medical-mandible'
import { 
  Eye, RotateCcw, Play, Pause, MousePointer, Settings, Camera,
  Zap, Info, Target, Maximize2, Activity, Scan, Monitor
} from 'lucide-react'
...
export function Medical3DViewer({ 
  maleMean = {},
  femaleMean = {},
  className = ""
}: {
  ...
  const [viewMode, setViewMode] = useState<'lateral' | 'anterior' | 'superior'>('lateral')
      ...
      <Card className="glass-card border-orange-500/30 bg-gradient-to-br from-gray-900/95 to-orange-900/20">
        <CardHeader>
          <CardTitle className="flex items-center space-x-2 text-2xl text-gray-100">
            ...
            <span>Medical 3D Mandible Viewer</span>
          ...
          <CardDescription className="text-lg">
            Clinical-grade 3D visualization for forensic osteometric analysis
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="bg-gray-800/50 border border-orange-500/30 rounded-lg p-4">
            <div className="flex items-center space-x-2 mb-3">
              ...
              <h3 className="text-lg font-semibold text-gray-200">Morphological Analysis</h3>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <p className="text-sm text-gray-300 mb-2">
                  <strong>Sexual Dimorphism Index:</strong> {Math.round(morphFactor * 100)}%
                </p>
                <p className="text-sm text-gray-300 mb-2">
              ...
              {currentFeature ? (
                ...
                <div className="p-3 bg-gray-800/50 rounded-lg border border-gray-700">
                  ...
                  <div className="text-xs text-gray-500">
                    <strong>Current Analysis:</strong> {Math.round(morphFactor * 100)}% male morphology
                  </div>
                </div>
              )}
            </div>
          ...
          <div className="relative w-full h-[750px] bg-gradient-to-b from-gray-900 to-black rounded-xl overflow-hidden border-2 border-orange-500/30 shadow-2xl">
            ...
            >
              ...
              <ambientLight intensity={0.2} color="#ff8866" />
              <directionalLight 
                position={[8, 8, 4]} 
                intensity={1.5} 
                color="#ffffff"
              ...
              <div className="absolute bottom-4 left-4 right-4">
                <div className="bg-black/90 backdrop-blur-sm rounded-lg p-4 border border-orange-500/30">
                  ...
                  <div className="text-xs text-gray-400 mt-2 text-center">
                    Sexual Dimorphism Analysis • Forensic Osteometry
                  </div>
                </div>
              </div>
            )}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-sm text-gray-400 bg-gray-800/30 p-4 rounded-lg border border-gray-700">
            <div className="flex items-center space-x-2">
              ...
              <span>Interactive examination</span>
            </div>
            <div className="flex items-center space-x-2">
              <Eye className="w-4 h-4 text-green-400" />
              <span>Osteometric analysis</span>
            </div>
            <div className="flex items-center space-x-2">
